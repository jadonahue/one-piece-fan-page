...
switch (randomNumber) {
    ...
    case 30:
        ...
        document.querySelector(".devil-fruit-p").innerHTML = "Are artificial Zoan Devil Fruits created with SAD. Has a change to change the person into animal species hybrid or causing them to smile and laugh with no other way to show emotion."
            break;
